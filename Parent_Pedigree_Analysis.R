# Parent pedigree analysis of samples, using Mendelian inconsistent error counts.
...
# Prior to using this script, ensure SNP data is in PLINK .ped/.map format. Remove all duplicates.
# Also worth removing non-sample triploids - as per Howard et al. 2023, unlikely that triploids will be parents.
...
setwd("C:/Users/curly/Desktop/Apple Genotyping/Methods/2025_Extra_Otago_Samples/Inputs/Pedigree_Analysis")

# Changing format from .ped to .bed
system("plink --file Genotypes_Pedigree --make-bed --out Geno_BED")

# Run IBD calculation to generate .genome file, with a minimum IBD threshold
system("plink --bfile Geno_BED --genome full --min 0.4")
...
write.table(genome, "C:/Users/curly/Desktop/Apple Genotyping/Results/2025_Extra_Otago_Samples/Parent_Pedigree_Analysis/PLINK_IBD.txt", sep = "\t", row.names = FALSE, quote = FALSE)
...
SNPdata.filepath <- "C:/Users/curly/Desktop/Apple Genotyping/Methods/2025_Extra_Otago_Samples/Inputs/Pedigree_Analysis"
...
filename.trio.output <- "C:/Users/curly/Desktop/Apple Genotyping/Results/2025_Extra_Otago_Samples/Parent_Pedigree_Analysis/trios.txt"
filename.duo.output <- "C:/Users/curly/Desktop/Apple Genotyping/Results/2025_Extra_Otago_Samples/Parent_Pedigree_Analysis/duos.txt"

# Directory containing supplementary script "rutilsHMuranty_pedigree.R" 
function.filepath  <- "C:/Users/curly/Desktop/Apple Genotyping/Methods/2025_Extra_Otago_Samples/Inputs/Pedigree_Analysis/Muranty_Scripts"
...
png(filename = "C:/Users/curly/Desktop/Apple Genotyping/Results/2025_Extra_Otago_Samples/Parent_Pedigree_Analysis/ME_plot.png", width = 600, height = 600)
